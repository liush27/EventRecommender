	...
	public static void main(String[] args) {
		try {
			...
			sql = "CREATE TABLE items " + "(item_id VARCHAR(255) NOT NULL, " + " name VARCHAR(255), "
					...
					+ "zipcode VARCHAR(255), " + "date VARCHAR(255)," + "priceRange VARCHAR(255),"
					+ "rating FLOAT," + "address VARCHAR(255), " + "latitude FLOAT, "
			...
			// Step 4: insert data, Create a fake user
			sql = "INSERT INTO users " + "VALUES (\"1111\", \"3229c1097c00d282d586be050\", \"\", \"Smith\")";
